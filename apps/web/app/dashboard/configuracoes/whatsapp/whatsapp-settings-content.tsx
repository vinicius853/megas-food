...
const statusLabels = {
  ...
  AWAITING_CONFIGURATION: "Aguardando configuracao",
  CONNECTED: "Conectado",
  ERROR: "Com erro",
};
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader className="flex-row items-center justify-between">
              <div>
                <CardTitle>Conexao Evolution API</CardTitle>
            ...
            <CardContent className="grid gap-3 sm:grid-cols-2">
              <Info label="Numero da loja" value={settings.recipientPhone} />
              <Info label="Numero conectado" value={settings.connectedPhone} />
              <WhatsAppQrCard
                qr={state.qr}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <label className="flex items-center justify-between gap-4 rounded-lg border p-4">
                <div>
                  <p className="font-semibold">Enviar mensagens automaticas</p>
                  <p className="text-sm text-slate-500">
                    Desligado por padrao. O envio manual continua disponivel.
                  </p>
                </div>
                <input
                  type="checkbox"
